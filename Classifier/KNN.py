...
cv_clf = KNeighborsClassifier(n_neighbors=10,weights="distance",algorithm="auto")
...
yscore_sum.to_csv('yscore_sum_KNN.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_KNN.csv')
