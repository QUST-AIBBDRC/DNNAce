...
cv_clf  =AdaBoostClassifier(n_estimators=50)
...
yscore_sum.to_csv('yscore_sum_AdaBoost.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_AdaBoost.csv')
...
data_csv.to_csv(r'AdaBoost.csv')
